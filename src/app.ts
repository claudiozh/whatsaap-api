...
async function startSocket() {
  ...
  // // PEGAR LISTA DE GRUPOS
  // // Para pegar a foto do grupo, basta pegar o id do grupo e chamar p metodo de profilePictureUrl
  // setTimeout(async () => {
  ...
  // setTimeout(async () => {
  //   const profile = await socket.profilePictureUrl('120363019685226065@g.us', 'image');
